...
const TEST_VERSION =
  document.URL === "https://syncroomkr.github.io/" ? "ALPHA" : "BETA";
  ...
  return open ? (
    <div id="beta-noti-modal">
      ...
      <div className="temp-modal">
        <div className="title">
          SYNCROOM KOREA {TEST_VERSION} TEST에 오신 것을 환영합니다!
        </div>
        Syncroom Korea는 한국 사용자들이 더 편하게 싱크룸 방 입장 페이지를
        이용할 수 있도록 만들어진 웹사이트입니다.
        <br />
        <div style={{ color: "red" }}>
          * {TEST_VERSION} 버전이라 구현되지 않은 기능 및 일부 버그가
          존재합니다!!
        </div>
        ...
        <div className="issues">
          ...
          <ul>
            ...
            <li>
              <strong>
                이젠 안불쌍한 고3 개발자 입시 끝났습니다!! 조만간 업데이트하도록
                하겠습니다ㅎㅎㅎㅎ
              </strong>
            </li>
          </ul>
        ...
        <div className="contact">
          버그 제보 또는 기능 제안은{" "}
          <a href="mailto:kr.syncroom@gmail.com" color="#505050">
